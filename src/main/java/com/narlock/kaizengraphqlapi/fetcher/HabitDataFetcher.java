...
public class HabitDataFetcher {
    ...
    @DgsMutation
    public HabitEntry createHabitEntry(@InputArgument String name, @InputArgument Integer profileId, @InputArgument String date) {
    ...
    @DgsQuery
    public String habitEntryDate(@InputArgument String name, @InputArgument Integer profileId, @InputArgument String date) {
